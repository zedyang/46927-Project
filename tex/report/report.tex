...
\begin{abstract} 
In this project, we explore \cite{koh2017}. We successfully implement the efficient technique to calculate influence function that requires only oracle access to gradients and Hessian-vector products mentioned in the paper. 
\end{abstract} 
